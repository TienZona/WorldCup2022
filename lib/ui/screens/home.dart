      ...
      body: Container(  
        ...
        child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index){
            final id1 = nationManager.matchs[index].id_team_1;
            final id2 = nationManager.matchs[index].id_team_2;
            ...
            return CardNation(
              ...
              date: nationManager.matchs[index].date,
              time: nationManager.matchs[index].time,
              team_1_goal: nationManager.matchs[index].team_1_goal,
              team_2_goal: nationManager.matchs[index].team_2_goal,
            );
          },
        ),
      ),
